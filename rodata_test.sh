...
/home/local/ASUAD/ekayang/Documents/LLVM/llvm-15/llvm-project/build/bin/opt -opaque-pointers=0 --load-pass-plugin=./rodata_pass/build/SplitRodataPass.so --passes="split-rodata" benchmarks/lifted/oobr_direct_index_integer.ll -o rodata_test.bc
