...
entry:
  ...
  %10 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 4) to i32*, !ROData_Index !1
  %memload = load i32, i32* %10, align 1, !ROData_Content !2
  store i32 %memload, i32* %RBP_N.11, align 1
  %11 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 8) to i16*, !ROData_Index !3
  %memload1 = load i16, i16* %11, align 1, !ROData_Content !4
  store i16 %memload1, i16* %RBP_N.7, align 1
  %memload2 = load i8, i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 10), align 1, !ROData_Content !5
  store i8 %memload2, i8* %RBP_N.5, align 1
  %12 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 11) to i64*, !ROData_Index !6
  %memload3 = load i64, i64* %12, align 1, !ROData_Content !7
  store i64 %memload3, i64* %RBP_N.25, align 1
  %13 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 19) to i32*, !ROData_Index !8
  %memload4 = load i32, i32* %13, align 1, !ROData_Content !9
  store i32 %memload4, i32* %RBP_N.17, align 1
  %14 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 23) to i16*, !ROData_Index !10
  ...
  %EAX = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 25), i64 %memload7)
  %memload8 = load i64, i64* %RBP_N.48, align 1
  %EAX9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 39), i64 %memload8)
  ...
  store i32 1145307204, i32* %20, align 1
  %memload13 = load i64, i64* %RBP_N.40, align 1
  %EAX14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 25), i64 %memload13)
  %memload15 = load i64, i64* %RBP_N.48, align 1
  %EAX16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 54), i64 %memload15)
...
bb.1:                                             ; preds = %entry
  %EAX25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 68))
  br label %bb.2
...
!0 = !{i64 4202496}
!1 = !{i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 4)}
!2 = !{!1}
!3 = !{i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 8)}
!4 = !{!3}
!5 = !{i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 10)}
!6 = !{i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 11)}
!7 = !{!6}
!8 = !{i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 19)}
!9 = !{!8}
!10 = !{i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 23)}
!11 = !{!10}
