...
entry:
  ...
  %4 = ptrtoint ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 4) to i64, !ROData_Index !1
  store i64 %4, ptr %RBP_N.16, align 1
  %5 = ptrtoint ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 10) to i64, !ROData_Index !2
  ...
  %EAX = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 16), i32 %ESI)
  %memload2 = load i64, ptr %RBP_N.16, align 1
  %memref-disp3 = add i64 %memload2, 5
  %8 = inttoptr i64 %memref-disp3 to ptr
  %memload4 = load i32, ptr %8, align 1
  %9 = trunc i32 %memload4 to i8
  %ESI5 = sext i8 %9 to i32
  %EAX6 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 49), i32 %ESI5)
  %memload7 = load i64, ptr %RBP_N.16, align 1
  %memref-disp8 = add i64 %memload7, 6
  %10 = inttoptr i64 %memref-disp8 to ptr
  %memload9 = load i32, ptr %10, align 1
  %11 = trunc i32 %memload9 to i8
  %ESI10 = sext i8 %11 to i32
  %EAX11 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 83), i32 %ESI10)
  %memload12 = load i64, ptr %RBP_N.16, align 1
  %memref-disp13 = add i64 %memload12, 6
  %12 = inttoptr i64 %memref-disp13 to ptr
  %memload14 = load i32, ptr %12, align 1
...
bb.1:                                             ; preds = %entry
  %EAX16 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 107))
  br label %bb.2
...
!2 = !{ptr getelementptr inbounds ([154 x i8], ptr @rodata_15, i32 0, i32 10)}
