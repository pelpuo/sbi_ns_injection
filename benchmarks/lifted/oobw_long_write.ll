...
entry:
  ...
  %memload = load i32, ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 4), align 1, !ROData_Content !1
  store i32 %memload, ptr %RBP_N.11, align 1
  %memload1 = load i16, ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 8), align 1, !ROData_Content !2
  store i16 %memload1, ptr %RBP_N.7, align 1
  %memload2 = load i8, ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 10), align 1, !ROData_Content !3
  store i8 %memload2, ptr %RBP_N.5, align 1
  %memload3 = load i64, ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 11), align 1, !ROData_Content !4
  store i64 %memload3, ptr %RBP_N.25, align 1
  %memload4 = load i32, ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 19), align 1, !ROData_Content !5
  store i32 %memload4, ptr %RBP_N.17, align 1
  %memload5 = load i16, ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 23), align 1, !ROData_Content !6
  ...
  %EAX = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 25), i64 %memload7)
  %memload8 = load i64, ptr %RBP_N.48, align 1
  %EAX9 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 39), i64 %memload8)
  ...
  store i64 4919420920202273057, ptr %16, align 1
  %memload13 = load i64, ptr %RBP_N.40, align 1
  %EAX14 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 25), i64 %memload13)
  %memload15 = load i64, ptr %RBP_N.48, align 1
  %EAX16 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 54), i64 %memload15)
...
bb.1:                                             ; preds = %entry
  %EAX25 = call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 68))
  br label %bb.2
...
!2 = !{ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 8)}
!3 = !{ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 10)}
!4 = !{ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 11)}
!5 = !{ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 19)}
!6 = !{ptr getelementptr inbounds ([145 x i8], ptr @rodata_15, i32 0, i32 23)}
