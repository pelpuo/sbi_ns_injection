; ModuleID = './protected_bc/oobw_direct_index_string.bc'
...
entry:
  ...
  %ns_base4 = getelementptr i8, i8* %stktop_8, i64 18
  ...
  %0 = bitcast i8* getelementptr inbounds ([105 x i8], [105 x i8]* @rodata_15, i32 0, i32 4) to i32*, !ROData_Index !1
  %memload = load i32, i32* @rodata_15_4, align 1, !ROData_Content !2
  %1 = bitcast i64* %RSPAdj_N.16 to i8*
  %2 = getelementptr i8, i8* %1, i64 6
  %3 = bitcast i8* %2 to i32*
  store i32 %memload, i32* %3, align 1
  %4 = bitcast i8* getelementptr inbounds ([105 x i8], [105 x i8]* @rodata_15, i32 0, i32 8) to i16*, !ROData_Index !3
  %memload1 = load i16, i16* @rodata_15_8, align 1, !ROData_Content !4
  store i16 %memload1, i16* %ns_ptr6, align 1
  %5 = bitcast i8* getelementptr inbounds ([105 x i8], [105 x i8]* @rodata_15, i32 0, i32 10) to i32*, !ROData_Index !5
  %memload2 = load i32, i32* @rodata_15_10, align 1, !ROData_Content !6
  %6 = bitcast i64* %RSPAdj_N.16 to i32*
  store i32 %memload2, i32* %6, align 1
  %7 = bitcast i8* getelementptr inbounds ([105 x i8], [105 x i8]* @rodata_15, i32 0, i32 14) to i16*, !ROData_Index !7
  %memload3 = load i16, i16* @rodata_15_14, align 1, !ROData_Content !8
  %8 = bitcast i64* %RSPAdj_N.16 to i8*
  %9 = getelementptr i8, i8* %8, i64 4
  %10 = bitcast i8* %9 to i16*
  store i16 %memload3, i16* %10, align 1
  %11 = bitcast i32* %ns_ptr3 to i8*
  store i8 120, i8* %11, align 1
  %12 = ptrtoint i64* %RSPAdj_N.16 to i64
  %RSI = add i64 %12, 6
  ...
  %13 = bitcast i64* %RSPAdj_N.16 to i32*
  %memload6 = load i32, i32* %13, align 1
  %14 = trunc i32 %memload6 to i8
  %EAX7 = sext i8 %14 to i32
  %15 = sub i32 %EAX7, 120
  %16 = call { i32, i1 } @llvm.usub.with.overflow.i32(i32 %EAX7, i32 120)
  %CF = extractvalue { i32, i1 } %16, 1
  %ZF = icmp eq i32 %15, 0
  %highbit = and i32 -2147483648, %15
  %SF = icmp ne i32 %highbit, 0
  %17 = call { i32, i1 } @llvm.ssub.with.overflow.i32(i32 %EAX7, i32 120)
