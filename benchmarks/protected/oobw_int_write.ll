; ModuleID = './protected_bc/oobw_int_write.bc'
...
entry:
  ...
  %0 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 4) to i32*, !ROData_Index !1
  %memload = load i32, i32* @rodata_15_4, align 1, !ROData_Content !2
  store i32 %memload, i32* %ns_ptr9, align 1
  %1 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 8) to i16*, !ROData_Index !3
  ...
  %2 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 11) to i64*, !ROData_Index !6
  %memload3 = load i64, i64* @rodata_15_11, align 1, !ROData_Content !7
  store i64 %memload3, i64* %ns_ptr18, align 1
  %3 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 19) to i32*, !ROData_Index !8
  %memload4 = load i32, i32* @rodata_15_19, align 1, !ROData_Content !9
  store i32 %memload4, i32* %ns_ptr15, align 1
  %4 = bitcast i8* getelementptr inbounds ([144 x i8], [144 x i8]* @rodata_15, i32 0, i32 23) to i16*, !ROData_Index !10
  ...
  %10 = inttoptr i64 %memload12 to i32*
  store i32 1145307204, i32* %10, align 1
